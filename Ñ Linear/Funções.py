...
###REMOVI A MEYER E A GULFRADF pois estava encontrando o ponto mínimo delas
###diferente do mínimo que o livro diz, então assumi não ter conseguido 
###as implementar corretamente.
...
###Osborne 1 e Brown and Dennis demoram muito no método do gradiente, então tirei ambas para poder manter tal método 
...
###mínimo está dando valor errado, então removi.
