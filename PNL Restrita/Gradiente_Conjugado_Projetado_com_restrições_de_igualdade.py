...
def GradProj(G,c,A,b,x):
     #se a matriz tem rank igual à dimensão do problema, então ele só tem uma solução.
    if np.linalg.matrix_rank(A) == len(x):
